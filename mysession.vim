...
silent only
silent tabonly
cd ~/workspace/spring-boot-custom-login-page
...
badd +0 ~/.config/nvim/lua/custom/plugins/configs/null-ls.lua
argglobal
%argdel
...
wincmd w
argglobal
if bufexists(fnamemodify("pom.xml", ":p")) | buffer pom.xml | else | edit pom.xml | endif
if &buftype ==# 'terminal'
  silent file pom.xml
endif
balt build.gradle
